...
#  Background:
  ...
  Scenario Outline: : Already login operator
    ...
    Then    Status code login operator should be 200
    Examples:
      | json                   |
...
#  POSITIVE
  ...
  Scenario Outline: Post create add a new parking with valid body json and token authorization operator
    Given   Post create add a new parking with valid location "Lapangan Meria", city "Kota Tebing Tinggi", imageloc "lpp.jpg"
